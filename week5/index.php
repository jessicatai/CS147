...
<div data-role="page" id="one" data-theme="b">
	...
	<div data-role="content">	
		...
		<?php 
			$now = time();
			$elecStart = mktime(7,0,0,11,6,2012);
			//echo "<p>elec ".$elecStart."</p>";
			//echo "<p>elec ".$now."</p>";
			$hours = ($elecStart - $now) / (60 * 60);
			//echo "<p>hours ".$hours."</p>";
			echo "<p>Polls open at 7 am on Nov. 6, 2012</p>";
			echo "<p>NOTICE - Hours until start of election (in local time): ".$hours."</p>";
		?>
...
<div data-role="page" id="two" data-add-back-btn="true" data-theme="b">
